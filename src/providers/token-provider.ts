...
export const T1_MAISTESTSUBNET = new Token(
...
export const T2_MAISTESTSUBNET = new Token(
  ChainId.MAISTESTSUBNET,
  '0xB1d46eB9c285764334b4f85c15d6722b3b49d6CB',
  18,
  'TEST',
  'TestERC20'
);
export const T3_MAISTESTSUBNET = new Token(
  ChainId.MAISTESTSUBNET,
  '0xC2E2e48913b2Beb89Df57cd3B4Ddf4B59aE1DfF2',
  18,
  'TEST',
  'TestERC20'
);
