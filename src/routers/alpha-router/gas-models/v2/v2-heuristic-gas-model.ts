...
export const BASE_SWAP_COST = BigNumber.from(200000); // 115000, bumped up by 20_000 @eric 7/8/2022

// Constant per extra hop in the route.
export const COST_PER_EXTRA_HOP = BigNumber.from(80000); // 20000, bumped up by 30_000 @eric 7/8/2022
